            ...
            <aside>
                <div id="sidebar" class="nav-collapse ">
                    ...
                    <ul class="sidebar-menu" id="nav-accordion">
                        ...
                        <li class="sub-menu">
                            <a class="active" href="user-transaction.php">
                        ...
                        <table id="myTable" class="ttable table-striped table-bordered data" width="95%">
                            ...
                            <tbody>
                                ...
                                while ($row = $query->fetch_assoc()) {
                                    ...
                                    <td>
                                    <a href='user-transaction-print.php?id=" . $row['code_transaction'] . "' class='btn btn-success btn-sm'><span class='glyphicon glyphicon-print'></span> Print</a>
                                    </td>
                                    </tr>";
